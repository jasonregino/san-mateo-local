...
const ROTATION = [
  { focus: 'New restaurants, cafes & bars', terms: ['restaurant', 'new restaurant', 'cafe', 'coffee shop', 'bakery', 'bar'] },
  { focus: 'Health, fitness & wellness', terms: ['gym', 'fitness studio', 'yoga studio', 'pilates studio', 'chiropractor', 'physical therapy', 'massage therapy', 'med spa', 'acupuncture'] },
  { focus: 'Personal services', terms: ['hair salon', 'barber shop', 'nail salon', 'dentist', 'optometrist', 'day spa'] },
  { focus: 'Pets, auto & cleaners', terms: ['veterinarian', 'pet grooming', 'auto repair', 'dry cleaner', 'tailor alterations'] },
  { focus: 'Shopping', terms: ['boutique', 'gift shop', 'bookstore', 'florist', 'specialty grocery', 'home goods store'] },
  { focus: 'Things to do', terms: ['art gallery', 'escape room', 'entertainment', 'bowling alley', 'live music venue'] },
];
